        ...
        <div>
            <div className='row my-5 align-items-center home-content'>
                <div className="col-lg-7 col-md-7">
                    ...
                    <h1 className='fw-bold text-primary'>Your best Laptop</h1>
                    <p className=''>Laptops combine all the input/output components and capabilities of a desktop computer, including the display screen, small speakers, a keyboard, data storage device.</p>
            ...
            <div className='customer-reviews row g-3'>

                <h2>Review: {revSlice.length}</h2>
